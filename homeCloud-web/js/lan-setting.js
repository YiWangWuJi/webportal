...
var lanIndex = {
		...
		getDhcpConfigInfo : function() {
			...
			callRpc(rpcUrl + this.paramOperate.businessType + token, this.paramOperate.method.getConfigInfo, params, this.lanConnectInfoCallBack);
		},
		/**
		 * 获取dhcp配置信息回调
		 */
		...
		saveLanConnectInfo : function() {
			...
			var params = [{'defaultgateway':'默认网关'}, {'start':$('#ip_start').val()}, {'limit':ipLimit}, {'leasetime':'租赁期限'} ];
